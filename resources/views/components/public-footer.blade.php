    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a class="{{ request()->routeIs('privacy-policy') ? 'text-white font-medium' : 'text-gray-400 hover:text-white transition-colors' }} text-sm" href="{{ route('privacy-policy') }}">Privacy
                            Policy</a></li>
                    <li><a class="{{ request()->routeIs('terms-of-service') ? 'text-white font-medium' : 'text-gray-400 hover:text-white transition-colors' }} text-sm"
                            href="{{ route('terms-of-service') }}">Terms of Service</a></li>
                    <li><a class="{{ request()->routeIs('anti-spam-policy') ? 'text-white font-medium' : 'text-gray-400 hover:text-white transition-colors' }} text-sm"
