...
@section('title', 'Tambah Kata Blacklist')
@section('page-title', 'Tambah Kata Blacklist')
@section('page-subtitle', 'Tambahkan kata baru ke daftar blacklist')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="severity" id="severity" required
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-white">
                        <option value="block" {{ old('severity') == 'block' ? 'selected' : '' }}>Block - Pesan akan diblokir</option>
                        <option value="warning" {{ old('severity') == 'warning' ? 'selected' : '' }}>Warning - Hanya peringatan</option>
                    </select>
                    <p class="mt-1 text-sm text-gray-500">Block akan mencegah pesan terkirim. Warning hanya mencatat log.</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="reason" id="reason" value="{{ old('reason') }}"
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-white"
                        placeholder="Contoh: Termasuk kategori judi online">
                </div>
