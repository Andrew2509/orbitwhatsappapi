    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (app()->isLocal()) {
            ...
            $csp = "default-src 'none'; " .
                   ...
                   "connect-src 'self' https://bot.orbitwaapi.site wss://bot.orbitwaapi.site https://*.firebaseio.com https://*.googleapis.com https://*.google-analytics.com https://*.analytics.google.com https://*.doubleclick.net https://stats.g.doubleclick.net https://analytics.google.com https://accounts.google.com https://www.gstatic.com https://cdn.jsdelivr.net https://consent.cookiebot.com https://consentcdn.cookiebot.com https://app.sandbox.midtrans.com https://app.midtrans.com wss://*.pusher.com https://*.pusher.com https://cloudflareinsights.com https://static.cloudflareinsights.com; " .
